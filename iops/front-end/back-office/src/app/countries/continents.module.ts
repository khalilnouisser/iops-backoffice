...
import {CountriesRoutingModule} from "./countients.routing";
import {FormsModule,ReactiveFormsModule} from "@angular/forms";
import {HttpModule} from "@angular/http";
import {CountriesComponent} from "./continents.component";
...
@NgModule({
  ...
  declarations: [CountriesComponent, AddComponent, ListComponent, UpdateComponent],
