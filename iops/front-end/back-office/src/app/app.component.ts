...
export class AppComponent implements OnInit {
  ...
  constructor(public config:ConfigService,public authService: AuthService) {
  }

  public ngOnInit(): void {
    this.navItems = [
      { type: NavItemType.Sidebar, title: 'Dashboard', routerLink: 'dashboard', iconClass: 'pe-7s-graph' },
      { type: NavItemType.Sidebar, title: 'Continents', routerLink: 'continents', iconClass: 'pe-7s-graph' },
      { type: NavItemType.Sidebar, title: 'Countries', routerLink: 'countries', iconClass: 'pe-7s-graph' },
      { type: NavItemType.Sidebar, title: 'News', routerLink: 'news', iconClass: 'pe-7s-graph' },
      { type: NavItemType.Sidebar, title: 'Messages', routerLink: 'messages', iconClass: 'pe-7s-graph' },
      { type: NavItemType.Sidebar, title: 'Admins', routerLink: 'admins', iconClass: 'pe-7s-user' },
      { type: NavItemType.Sidebar, title: 'Contestants', routerLink: 'contestants', iconClass: 'pe-7s-user' },
      { type: NavItemType.Sidebar, title: 'Institutions', routerLink: 'institutions', iconClass: 'pe-7s-user' },
